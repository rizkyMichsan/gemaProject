...
*/
$config['tables']['ic_users']           = 'ic_users';
$config['tables']['ic_groups']          = 'ic_groups';
$config['tables']['ic_users_groups']    = 'ic_users_groups';
$config['tables']['ic_login_attempts']  = 'ic_login_attempts';
 ...
 */
$config['join']['ic_users']  = 'user_id';
$config['join']['ic_groups'] = 'group_id';
 ...
 */
$config['site_title']                 = "hankam.bappenas.go.id";       // Site Title, example.com
