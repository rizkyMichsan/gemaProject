...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="<?= base_url() ?>assets\assets\icon\themify-icons\themify-icons.css">
  <!-- ico font -->
        ...
        <div class="col-sm-12">
          ...
          <form class="md-float-material form-material">
            <div class="text-center">
              <img src="<?= base_url() ?>assets\assets\images\logo.png" alt="logo.png">
            </div>
            <div class="auth-box card">
              <div class="card-block">
                ...
                <p class="text-inverse text-left">Don't have an account?<a href="javascript:void(0)"> Please contact <b class="f-w-600">Administrator </b></a>!</p>
              </div>
            </div>
          </form>
          <!-- end of form -->
